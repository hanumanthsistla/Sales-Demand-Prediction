...
if __name__ == '__main__':
    ...
    modelfile = 'F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Model_Files/sales_vsp_day_jan20_volume.pickle'

    model = pickle.load(open(modelfile, 'rb'))

    print("sales Prediction Pickle Predict Model is Loaded: Flask Test Server is Running on port:8001")

def main():
    """Run the app."""
    app.run(host='0.0.0.0', port=8001, debug=True)  # nosec
