...
Dataset: 'F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20.csv'
...
data = pd.read_csv('F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20_mod.csv',  delimiter=',', encoding= 'unicode_escape', header=0, parse_dates=['BILLING_DATE'])
...
data.to_csv(r'F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Sales_Imputed_Datasets/aiml_sales_inv_jan20_mod.csv', index=False) 
...
with open("F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Model_Files/sales_vsp_day_jan20.pickle", 'wb') as handle:
    pickle.dump(RF, handle, protocol=pickle.HIGHEST_PROTOCOL)


print('\nSales VSP Dataset Used: F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20_mod.csv')

print('\nSaved sales_vsp_day_jan20.pickle model successfully to location: F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Model_Files/sales_vsp_day_jan20.pickle')
