# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 13:23:18 2020
...
plot_layout = go.Layout(
        title='Fig1: Monthly Sales'
    )
fig = go.Figure(data=plot_data, layout=plot_layout)
pyoff.iplot(fig)
# Below code opens figure in new browser as html file
pyoff.plot(fig)
# plt.show()
