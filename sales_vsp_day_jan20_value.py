...
Dataset: 'F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20_value.csv'
...
data = pd.read_csv('F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20_value.csv',  delimiter=',', encoding= 'unicode_escape', header=0, parse_dates=['BILLING_DATE'])
...
X = np.array(data.drop(['BILLING_DATE','SALES_VALUE'],axis=1))

# Test selection

# Z = np.array(data['BILLING_DATE'])
# try:
Y = np.array(data['SALES_VALUE'])
# except KeyError:
...
with open("F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Model_Files/sales_vsp_day_jan20_value.pickle", 'wb') as handle:
    pickle.dump(RF, handle, protocol=pickle.HIGHEST_PROTOCOL)


print('\nSales VSP Dataset Used: F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/aiml_sales_day_jan20_value.csv')

print('\nSaved sales_vsp_day_jan20.pickle model successfully to location: F:/ML_Project_April_2020/SD_Sales_Predict_ML_Projects/Model_Files/sales_vsp_day_jan20_value.pickle')
